  ...
  Våxnäsgatan 150, Karlstad<br>
        ...
        <div class="flex items-center lg:px-14 xl:px-20">
          <form name="contact" method="POST"  data-netlify="true" class="space-y-6 w-full" >
            ...
            <div class="space-y-1">
              <label for="message" class="font-medium">Message
              <textarea class="block border border-gray-200 rounded bg-gray-900 placeholder-gray-400 px-5 py-3 w-full focus:border-rose-500 focus:ring focus:ring-rose-500 focus:ring-opacity-50" name="message" id="message" required placeholder="Message"  rows="6"></textarea></label>
            </div>
