  ...
  <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-10">
    <div class="flex flex-col lg:flex-row lg:items-center space-y-12 lg:space-y-0 lg:space-x-20">
      ...
      <div class="lg:w-5/12 xl:w-5/12 md:py-12 space-y-10 ">
        <div>
          ...
          <h3 class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-500">
            Vi ebjuder din bil tre behandlingar: 3-stegs polering för utsidan eller/och invändig rekond för insidan och keramiskt lackskydd för att bevara skönheten.
          </h3>
        </div>
      </div>
      <!-- END Heading -->
      ...
      <div class="lg:w-7/12 xl:w-7/12 flex-none relative ">
        <div class="pattern-dots-xl opacity-20 absolute top-0 left-0 w-48 h-64 md:mt-20 transform -translate-x-10 -translate-y-10"></div>
        <div class="pattern-dots-xl  opacity-20 absolute bottom-0 right-0 w-48 h-64 md:mb-20 transform translate-x-10 translate-y-10"></div>
