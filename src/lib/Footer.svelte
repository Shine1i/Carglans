<!-- Footer Section: Simple With Social Dark -->
<footer id="page-footer" class="bg-gray-800">
  <div class="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
    <nav class="space-x-4">
      ...
      <a href="https://www.facebook.com/people/Carglans-i-Karlstad-AB/100085366727420/" class="text-gray-400 hover:text-rose-400">
      ...
      <a href="https://www.instagram.com/carglanskarlstad/" class="text-gray-400 hover:text-rose-400">
    ...
    <nav class="space-x-2 sm:space-x-4">
      <a href="/omOss" class="font-medium text-gray-300 hover:text-gray-400">
        Om Oss
      </a>
    ...
    <div class="text-gray-400">
      <span class="font-medium">Carglans i Karlstad AB</span> ©
    </div>
  </div>
</footer>
<!-- END Footer Section: Simple With Social Dark -->